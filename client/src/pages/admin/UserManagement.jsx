...
export default function UserManagement() {
    const [users, setUsers] = useState([
        { id: 1, name: 'John Doe', email: 'john@example.com', role: 'Patient', status: 'active', joinDate: '2026-01-15' },
        { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Volunteer', status: 'active', joinDate: '2026-01-20' },
        { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'Patient', status: 'inactive', joinDate: '2025-12-10' },
        { id: 4, name: 'Alice Brown', email: 'alice@example.com', role: 'Admin', status: 'active', joinDate: '2025-11-01' },
